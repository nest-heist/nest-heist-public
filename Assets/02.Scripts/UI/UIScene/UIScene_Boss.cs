...
/// 던전 씬 UI
/// </summary>
public class UIScene_Boss : UIScene, IScene
{
    [Header("Image")]
    ...
    public UIScene_Boss_Presenter Presenter;
    ...
    public void SetBattleManager(IBattleManager battleManager)
    {
        ...
        Presenter = new UIScene_Boss_Presenter(this);
        Presenter.Init();
    ...
    public void SetBossHpFillAmount(float bossHp)
    {
        BossHpImage.fillAmount = bossHp;
    }

    public void SetHeadBossIcon(Sprite sprite)
    {
        BossHeadIcon.sprite = sprite;
    }
}

public class UIScene_Boss_Presenter : Presenter
{
    private UIScene_Boss _view;
    ...
    public UIScene_Boss_Presenter(UIScene_Boss view)
    {
        _view = view;
        ...
        _bossHealthSystem = GameObject.FindObjectOfType<BossHealthSystem>();
    ...
    public void Init()
    {
        ...
        _bossHealthSystem.OnHPChangedEvent -= UpdateBossHp;
        _bossHealthSystem.OnHPChangedEvent += UpdateBossHp;
        _view.SetHeadBossIcon(BossHeadIcon());
        _bossHealthSystem.OnDeathEvent.RemoveAllListeners();
        _bossHealthSystem.OnDeathEvent.AddListener(() => OnBossClearScreen());
    }

    public Sprite BossHeadIcon()
    {
        Sprite bossHead = ResourceManager.Instance.LoadSprite("Icon/MonsterIcon/", GameManager.Instance.DungeonStageSystem.BossSelectedId);
        return bossHead;
    }
    ...
    {
        string userName = DataManager.Instance.ServerDataSystem.User.Username;
    ...
    {
        float bossHpRation = currentHp / maxHp;
        _view.SetBossHpFillAmount(bossHpRation);
    }

    private void OnBossClearScreen()
    {
        UIManager.Instance.InstanciateUIPopup<UIPopup_BossRewardScreen>();
    }
}